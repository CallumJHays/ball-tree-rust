...
//--------------------- 256 length vectors ---------------------
#[bench]
fn random_benchmark_tree_10x8_bench(b: &mut test::Bencher) {
    let SIZE = pow2(10);
    let LENGTH = pow2(8);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_14x8_bench(b: &mut test::Bencher) {
    let SIZE = pow2(14);
    let LENGTH = pow2(8);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_18x8_bench(b: &mut test::Bencher) {
    let SIZE = pow2(18);
    let LENGTH = pow2(8);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_20x8_bench(b: &mut test::Bencher) {
    let SIZE = pow2(20);
    let LENGTH = pow2(8);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
...
//--------------------- 512 length vectors ---------------------
#[bench]
fn random_benchmark_tree_10x9_bench(b: &mut test::Bencher) {
    let SIZE = pow2(10);
    let LENGTH = pow2(9);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_14x9_bench(b: &mut test::Bencher) {
    let SIZE = pow2(14);
    let LENGTH = pow2(9);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_18x9_bench(b: &mut test::Bencher) {
    let SIZE = pow2(18);
    let LENGTH = pow2(9);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_20x9_bench(b: &mut test::Bencher) {
    let SIZE = pow2(20);
    let LENGTH = pow2(9);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
...
//--------------------- 1024 length vectors ---------------------
#[bench]
fn random_benchmark_tree_10x10_bench(b: &mut test::Bencher) {
    let SIZE = pow2(10);
    let LENGTH = pow2(10);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_14x10_bench(b: &mut test::Bencher) {
    let SIZE = pow2(14);
    let LENGTH = pow2(10);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_18x10_bench(b: &mut test::Bencher) {
    let SIZE = pow2(18);
    let LENGTH = pow2(10);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
#[bench]
fn random_benchmark_tree_20x10_bench(b: &mut test::Bencher) {
    let SIZE = pow2(20);
    let LENGTH = pow2(10);
    b.iter(|| random_benchmark_tree(SIZE, LENGTH))
}
...
//     let SIZE = pow2(8);
//     b.iter(|| {
//         random_benchmark_tree(SIZE, LENGTH)
//         .push(&gen_random_vector(LENGTH))
//     })
// }
...
//     b.iter(|| {
//         random_benchmark_tree(SIZE, LENGTH)
//         .nn_search(&gen_random_vector(LENGTH), &SEARCH)
//     })
// }
